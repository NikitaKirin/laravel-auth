                    ...
                    <div class="flex items-center gap-x-4 lg:gap-x-6">
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div
                                ...
                                <a href="#" x-data x-on:click.prevent="$refs.logout.submit()" class="block px-3 py-1 text-sm leading-6 text-gray-900" role="menuitem"
                                   tabindex="-1" id="user-menu-item-1">
                                    Выйти
                                    <x-form x-ref="logout" action="{{ route('logout') }}" class="hidden" method="post"/>
                                </a>
                            </div>
                        </div>
                    </div>
